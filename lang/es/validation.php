...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado aparece en una fuga de datos. Elige otro.',
    ],
    ...
    | que sea rápido especificar un mensaje personalizado para una regla dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar marcadores de
    | posición de atributos con algo más legible, como "Correo Electrónico" en lugar
    | de "email". Esto simplemente ayuda a hacer que nuestro mensaje sea más expresivo.
    |
    */
